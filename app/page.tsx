  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative z-10 container mx-auto p-3 sm:p-4 pt-20 sm:pt-24 pb-6 sm:pb-8">
                  ...
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    ...
                    {projects.length > 3 && <Button
                      ...
                      onClick={() => {
                        ...
                        if (projectGrid) {
                          const isExpanded = projectGrid.classList.contains("lg:grid-cols-4")
                          if (isExpanded) {
                            projectGrid.className = "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4"
                          } else {
                            projectGrid.className = "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4"
                          }
                        }
                      }}
                    >
        ...
        >
          <p>© {new Date().getFullYear()} Abhijeet Srivastava. All rights reserved.</p>
        </AnimatedSection>
      </div>
